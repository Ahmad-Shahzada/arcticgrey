        ...
        <div className='mx-5 bg-white mt-10 rounded-[24px] lg:rounded-[14px] relative group overflow-hidden'>
            <div className="w-full bg-white flex items-center justify-center p-6 md:px-12 lg:px-20 font-sans antialiased text-black">
                <div className="w-full relative">
                    ...
                    <button className="prev-btn absolute left-[-20px] lg:left-[-70px] top-1/2 -translate-y-1/2 z-30 hidden lg:flex h-12 w-12 items-center justify-center rounded-full bg-black text-white transition-all cursor-pointer shadow-md">
                        <ChevronLeft className="h-8 w-8" strokeWidth={1.5} />
                    </button>
                    <button className="next-btn absolute right-[-20px] lg:right-[-70px] top-1/2 -translate-y-1/2 z-30 hidden lg:flex h-12 w-12 items-center justify-center rounded-full bg-black text-white hover:bg-zinc-800 transition-all cursor-pointer shadow-md">
                            ...
                            <SwiperSlide key={index}>
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-20 items-center">
                                    ...
                                    <div className="relative w-full aspect-[4/3] order-1">
                                        ...
                                        />
                                        {/* Overlapping Video - Responsive Sizing */}
                                    ...
                                    <div className="flex flex-col items-center lg:items-start text-left gap-8 md:gap-12 pr-0 lg:pr-6 order-2 mb-6 lg:mb-0">
                                        <div className="flex flex-col items-start gap-6">
                                            ...
                                            <div className="flex flex-wrap items-center justify-start gap-2">
                                                <span className="text-black text-base md:text-lg font-medium tracking-tight">Apps we used:</span><br className=''/>
                                                <div className="flex items-center gap-2">
                                                    {slide.apps.map((appImg, i) => (
                                                        <img key={i} src={appImg} alt="App logo" className="h-[18px] md:h-[20px] px-1 md:px-2 w-auto" />
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <a href="#" className="group flex items-center gap-3 text-lg font-semibold text-black transition-colors hover:text-zinc-600">
                                                View Case Study
                                        ...
                                        {/* Testimonial Block */}
                                        <div className="w-full max-w-[550px] bg-[#FDF6F0] rounded-[20px] p-6 md:p-8 lg:p-10 text-black text-left">
                                            <blockquote className="text-[14px] md:text-[15px] leading-[1.6] font-normal tracking-tight mb-6 md:mb-8 italic">
                                                {slide.testimonial}
                                            </blockquote>
                                            ...
                                            <div className="flex items-center gap-4 pt-1">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-lg md:text-[19px] font-bold tracking-tight text-black">{slide.author}</span>
                                                    <span className="text-sm md:text-[16px] font-normal text-zinc-600">{slide.role}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
