        ...
        <div className="w-full lg:w-1/2 flex flex-col space-y-8 lg:space-y-10 z-10 px-0 lg:px-10 text-center lg:text-left items-center lg:items-start order-2 lg:order-1 mt-12 lg:mt-0">
          <div className="space-y-6">
            <h1 className="text-3xl md:text-4xl font-medium leading-tight">
              Seamless Shopify{' '}
              <span style={{ backgroundImage: goldGradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                POS
              </span>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  className={`group cursor-pointer flex items-center justify-between py-5 md:py-6 px-4 border-b-2 transition-all duration-300 ease-in-out
