  ...
  return (
    <section className="mx-0 md:mx-5 bg-white px-4 md:px-10 lg:px-14 py-8 md:py-12">
      ...
      <div className="flex flex-col lg:flex-row rounded-[24px] lg:rounded-[14px] overflow-hidden min-h-fit lg:min-h-[700px] shadow-sm">
        ...
        <div className="w-full lg:w-1/2 bg-[#FAF7F0] p-8 md:p-16 lg:p-24 flex flex-col justify-center items-center lg:items-start text-left order-2 lg:order-1">
          <div className="space-y-4 md:space-y-6">
            <h2 className="text-2xl md:text-4xl text-black leading-[1.2] lg:leading-[1.15] tracking-tight">
              Connect <span className="font-bold">Shopify</span> Products <br className="hidden md:block" />
              Through <span className="font-bold">ChatGPT</span>
            </h2>
            ...
            {features.map((feature, index) => (
              <div 
                ...
                className={`flex items-center justify-between py-5 md:py-6 px-4 border-b-2 transition-all duration-300 cursor-pointer
                  ${hoveredTab === index ? 'bg-white border-yellow-500' : 'border-zinc-200'}`}
              >
                <span className={`text-base md:text-lg font-normal transition-colors ${hoveredTab === index ? 'text-black' : 'text-zinc-800'}`}>
                  {feature.title}
                </span>
          ...
          <div className="mt-10 lg:mt-12 w-full sm:w-auto">
            <button className="w-full sm:w-auto bg-black hover:border hover:border-yellow-500 text-white px-8 md:px-10 py-4 md:py-6 rounded-full font-semibold flex items-center justify-center gap-3 hover:bg-zinc-800 transition-all active:scale-95 group">
        ...
        {/* --- RIGHT SIDE: VIDEO & ICONS (Now order-1 on mobile) --- */}
        <div className="w-full lg:w-1/2 bg-[#0C0C0C] relative flex items-center justify-center py-16 px-6 lg:p-20 overflow-hidden order-1 lg:order-2">
          ...
          <div 
            ...
            style={{ 
              backgroundImage: 'url("https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=2000")', 
          ...
          <div className="relative z-10 w-full max-w-[220px] md:max-w-[300px] aspect-[9/18.5] bg-zinc-900 rounded-[2.5rem] md:rounded-[3.5rem] border-[6px] md:border-[10px] border-zinc-800 shadow-2xl overflow-hidden">
             <video 
              ...
              src="/public/vidio/shopifyChat.mp4"
            />
          </div>

          {/* Floating ChatGPT Icon */}
          <div className="absolute top-[10%] left-[8%] md:top-[15%] md:left-[10%] lg:left-[15%] z-20 bg-black p-3 md:p-4 rounded-xl md:rounded-2xl border border-zinc-700 shadow-2xl transform -rotate-6 w-14 h-14 md:w-20 md:h-20 flex items-center justify-center">
            <img src="/public/images/chatgpt-icon-golden.webp" alt="ChatGPT" className="w-full h-auto object-contain" />
          </div>

          {/* Floating Shopify Icon */}
          <div className="absolute bottom-[10%] right-[8%] md:bottom-[15%] md:right-[10%] lg:right-[15%] z-20 bg-black p-3 md:p-4 rounded-xl md:rounded-2xl border border-zinc-700 shadow-2xl transform rotate-6 w-14 h-14 md:w-20 md:h-20 flex items-center justify-center">
             <img src="/public/images/shopify-iccon-black-back.webp" alt="Shopify" className="w-full h-auto object-contain" />
          </div>
