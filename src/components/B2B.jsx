                ...
                <div className="z-10 order-2 flex flex-col items-center p-5 sm:p-12 lg:order-1 lg:items-start lg:p-24 lg:pl-20 text-left">
                        ...
                        {features.map((feature, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`group flex cursor-pointer items-center justify-between border-b-2 lg:px-4 py-5 transition-all duration-300 md:py-6
                    ...
                    <div className="mt-10 w-full sm:w-auto">
                        <div
                            ...
                            className="inline-block cursor-pointer rounded-full p-[2px] transition-transform active:scale-95 w-full sm:w-auto"
                        >
