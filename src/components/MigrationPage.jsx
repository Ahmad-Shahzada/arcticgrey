...
const BackgroundWaves = () => (
  <svg className="absolute inset-0 w-full h-full text-zinc-800" fill="none" viewBox="0 0 1440 810">
    <path d="M100 200 C300 400, 400 0, 800 150 S1000 600, 1440 500" stroke="currentColor" strokeWidth="2" opacity="0.3" />
    <path d="M0 400 C300 100, 600 700, 900 400 S1200 600, 1440 300" stroke="currentColor" strokeWidth="1" opacity="0.1" />
  </svg>
);
const ArcticLogo = () => (
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full z-10">
          ...
          <div className="space-y-5 text-left order-2 lg:order-1">
            <h1 className="text-3xl md:text-4xl  font-light leading-[1.15]">
              ...
              <span style={{ backgroundImage: goldGradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} className="font-bold">
                Migration
              </span>{' '}
            ...
            <p className="text-zinc-400 text-base md:text-md max-w-[480px] pt-4 md:pt-6 leading-relaxed">
              ...
              <span className='font-semibold underline underline-offset-8 ml-2' style={{ color: '#dcab57' }}>try-before-you-buy</span> migration.
            </p>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="relative w-full h-2 bg-zinc-200 rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: `${progressPercentage}%`, background: goldGradient }}
                />
              </div>
            </div>
              ...
              {platforms.map((p) => (
                <label
                  ...
                  className={`
                    ...
                    ${selectedPlatform === p.id ? 'bg-white border-yellow-600 shadow-md' : 'bg-white/50 border-zinc-100 hover:border-zinc-300'}
                  `}
                >
