  ...
  return (
    ...
    <section className="mx-0 md:mx-5 bg-white px-4 md:px-10 lg:px-14 pt-10 pb-10">
      ...
      <div className="flex flex-col lg:flex-row rounded-[24px] lg:rounded-[14px] overflow-hidden min-h-fit lg:min-h-[700px] shadow-sm border border-zinc-100">
        ...
        <div className="w-full lg:w-1/2 bg-[#faf3e1] relative flex items-center justify-center p-8 md:p-12 lg:p-20 order-1 lg:order-1">
          ...
          <div className="space-y-6">
            <div className="flex flex-col lg:flex-row  gap-3">
              <h2 className="text-2xl md:text-4xl font-medium leading-tight">
                🎮 Gamify Your
                <span className='block lg:inline lg:pl-3' style={{ backgroundImage: goldGradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  className={`group cursor-pointer flex items-center justify-between py-5 md:py-6 px-1 lg:px-4 border-b-2 transition-all duration-300
