...
const B2B = () => {
    return (
        ...
        <div className="mx-3 lg:mx-5 bg-black text-[#e0f2f1] p-4 md:p-8 lg:p-12 min-h-screen font-sans overflow-x-hidden">
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-10">
                ...
                <div className="md:col-span-4 lg:col-span-4 pl-7 lg:pl-10 flex flex-col gap-10 md:gap-16 py-4 md:py-8">
                    ...
                    />
                    <ServiceItem
                        icon={<Settings className="text-primary-accent" size={24} />}
                ...
                <div className="md:col-span-8 lg:col-span-8 flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-black border border-[#e0f2f1]/20 rounded-[14px] p-6 lg:p-8 h-auto sm:h-48 backdrop-blur-sm">
                            <Layers3 className="text-primary-accent mb-4" size={24} />
                        ...
                        <div className="bg-black border border-[#e0f2f1]/20 rounded-[14px] p-6 lg:p-8 h-auto sm:h-48 backdrop-blur-sm">
                            <Database className="text-primary-accent mb-4" size={24} />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="relative border border-[#e0f2f1]/20 rounded-[14px] overflow-hidden h-[350px] md:h-[400px] flex flex-col ">
