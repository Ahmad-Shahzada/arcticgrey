                            ...
                            {features.map((feature, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`group cursor-pointer flex items-center justify-between py-5 md:py-6 lg:px-4 border-b-2 border-primary-soft transition-all duration-300 ease-in-out
