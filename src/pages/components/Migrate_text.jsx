...
export default function Migrate_text() {
  return (
    <section className="relative w-full  overflow-hidden mb-10 px-5">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center py-10">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-[#0A0A0A] leading-tight mb-8">
         What is the Shopify Test Drive?
        </h2>

        {/* Paragraph Text */}
        <p className="text-[#333333] text-base md:text-lg lg:text-xl leading-[1.7] md:leading-[1.8] max-w-5xl mx-auto font-normal">
         Just like test-driving a car before buying it, our Shopify Test Drive lets you try out Shopify without any risk. If you're on an old platform like Salesforce, Magento, or BigCommerce—or starting fresh—this free service gives you a personalized demo of how your business could run on Shopify.
        </p>
      </div>
    </section>
  );
