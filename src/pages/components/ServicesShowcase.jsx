...
const services = [
    {
        ...
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="3" width="7" height="7" rx="1" stroke="#10b981" strokeWidth="1.5" />
                <rect x="14" y="3" width="7" height="7" rx="3.5" stroke="#10b981" strokeWidth="1.5" />
                <path d="M14 17.5H21M17.5 14V21" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" />
                <circle cx="6.5" cy="17.5" r="3.5" stroke="#10b981" strokeWidth="1.5" />
            </svg>
        ),
        highlighted: false,
    },
    {
        ...
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 9L4 20H20L21 9" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M3 9H21V9C21 9 19.5 9 18 11C16.5 9 15 9 15 9C15 9 13.5 9 12 11C10.5 9 9 9 9 9C9 9 7.5 9 6 11C4.5 9 3 9 3 9Z" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M8 4H16L15 9H9L8 4Z" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ),
        highlighted: false,
    },
    {
        ...
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="5" cy="12" r="2" stroke="#10b981" strokeWidth="1.5" />
                <circle cx="19" cy="12" r="2" stroke="#10b981" strokeWidth="1.5" />
                <path d="M7 12H17" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 7L17 12L12 17" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ),
        highlighted: false,
    },
    {
        ...
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 18V19C9 20.6569 10.3431 22 12 22V22C13.6569 22 15 20.6569 15 19V18M9 18H15M9 18C7.13601 16.5097 6 14.3915 6 12C6 8.68629 8.68629 6 12 6C15.3137 6 18 8.68629 18 12C18 14.3915 16.864 16.5097 15 18M12 2V4" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ),
        highlighted: false,
    },
    {
        ...
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 7V12L15 15" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M19 5L21 3M5 5L3 3" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
        ),
        highlighted: false,
    },
                    ...
                    <div className="flex-1 flex flex-col order-2 xl:order-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-x-8">
                            {services.map((service, idx) => (
                                <Link to={URLS.SERVICE_PAGES.BUILD_1}
                                    key={idx}
                        ...
                        <div className="relative w-full h-auto md:h-[120px] rounded-2xl border-2 border-[#464646] bg-gradient-to-r from-[#111] to-[#050505] flex flex-col md:flex-row items-center p-6 md:p-0 md:pr-6 overflow-visible mt-16 mb-4">
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[150%] bg-primary-gradient opacity-[0.1] blur-[20px] pointer-events-none"></div>
                            ...
                            <div className="w-full flex-1 flex flex-col md:flex-row items-center justify-between md:ml-[290px] z-10 gap-6 md:gap-0">
                                ...
                                <div className='text-center md:text-left'>
                                    ...
                                    <p className="text-[18px] font-semibold text-primary-accent leading-tight">Get 10:00 Bulk Hours FREE</p>
                                </div>
