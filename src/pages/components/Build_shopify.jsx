...
export default function Build_shopify() {
  return (
    <section className="relative w-full overflow-hidden py-16 mb-10 px-5">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-[#0A0A0A] leading-tight mb-8">
          What is Building a New Shopify Store<br className="hidden md:block" />
         with Arctic Grey?
        </h2>

        {/* Paragraph Text */}
        <p className="text-[#333333] text-base md:text-lg lg:text-xl leading-[1.7] md:leading-[1.8] max-w-5xl mx-auto font-normal">
          hink of building a new Shopify store like constructing a custom home: We handle the blueprint, materials, and finishing touches so it fits your vision perfectly. If you're launching a brand-new eCommerce business—or upgrading from a basic setup—our service creates a fully custom Shopify store from the ground up, optimized for sales and scalability.
        </p>
      </div>
    </section>
  );
