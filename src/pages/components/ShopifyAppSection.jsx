  ...
  return (
    <div className="bg-white py-10 lg:py-16 px-3 sm:px-6 lg:mx-5 lg:px-16">
      <section className="max-w-[1400px] mx-auto">
        <div className="bg-light-bg rounded-[24px] lg:rounded-[14px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center">
          {/* LEFT: IMAGE */}
          ...
          <div className="p-8 md:p-12 lg:pr-20 lg:pl-10 lg:py-20 flex flex-col justify-center order-2">
            <div className="space-y-6">
              ...
              <p className="text-zinc-500 text-base md:text-md max-w-lg font-normal leading-relaxed">
                We're bringing our world-class expertise to Shopify App Development, helping
                merchants and entrepreneurs create custom private apps for their individual store
                needs and public apps ready to be listed on the Shopify App Store.
              </p>
            </div>
            ...
            <div className="mt-8 lg:mt-10">
              <button className="w-full sm:w-fit bg-primary-accent text-black px-2 lg:px-10 py-4 rounded-full font-bold flex items-center justify-center gap-3 hover:bg-light-text transition-all group shadow-md active:scale-95">
                Learn More about Shopify Apps
                <span className="group-hover:translate-x-2 transition-transform duration-300 italic text-lg">
                  →
                </span>
              </button>
            </div>
...
const FeatureRow = ({ Icon, title }) => (
  <div className="flex items-center justify-between py-6 group cursor-pointer transition-colors rounded-sm px-4">
    <span className="text-lg font-medium text-zinc-900 group-hover:text-primary-accent transition-colors">
      {title}
    </span>

    <div className="text-zinc-800 group-hover:text-primary-accent flex items-center justify-center ">
      <Icon />
    </div>
  </div>
);
