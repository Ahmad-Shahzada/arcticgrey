...
const SupportIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l-3 3m0 0l3 3m-3-3h13.5m-2.25-3.414a5.25 5.25 0 00-10.32 0M16.463 15.712a5.25 5.25 0 00-10.32 0"
    />
  </svg>
);
...
const MCP = () => {
  return (
    <div className="mx-0 md:mx-5 bg-white py-4 px-4 md:px-10 lg:px-14">
      <section>
        <div className="bg-light-bg px-2 md:px-5 rounded-[24px] lg:rounded-[14px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center">
          <div className="w-full flex items-center justify-center p-6 md:p-12 lg:p-0 order-1 lg:order-2">
            <img
              src="/images/mcp-image0.webp"
          ...
          <div className="p-5 md:p-12 lg:px-20 lg:py-20 flex flex-col justify-center order-2 lg:order-1 items-center lg:items-start text-left">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl md:text-4xl lg:text-4xl text-zinc-900 leading-[1.2] lg:leading-[1.1]">
                Storefront{" "}
                <span className="font-bold pr-1 lg:pr-3 bg-primary-gradient bg-clip-text text-transparent">
                  MCP
                </span>
                Integration Service
              </h2>
              ...
              <p className="text-zinc-600 text-sm md:text-base lg:text-md leading-relaxed max-w-xl font-light mx-auto lg:mx-0">
                Turn your store into a smart, conversational shopping experience
                with Storefront MCP. Powered by real-time Shopify data, it helps
                customers get instant, tailored answers that boost confidence and
                conversions.
              </p>
            </div>
            ...
            <div className="mt-10 w-full sm:w-auto">
              <button className="w-full sm:w-auto bg-primary-accent text-black px-8 lg:px-10 py-4 rounded-full font-semibold flex items-center justify-center gap-3 hover:bg-light-text transition-all group shadow-md active:scale-95 text-sm md:text-base">
                MCP Integration For $595
                <span className="group-hover:translate-x-2 transition-transform duration-300 text-xl md:text-2xl italic">
                  →
                </span>
              </button>
            </div>
...
const FeatureRow = ({ Icon, title }) => (
  <div className="flex items-center justify-between py-4 md:py-6 group cursor-pointer transition-colors rounded-sm lg:px-4 text-left">
    <span className="text-base md:text-xl font-medium text-zinc-900 group-hover:text-primary-accent transition-colors">
      {title}
    </span>

    <div className="text-zinc-800 group-hover:text-primary-accent flex items-center justify-center shrink-0">
      <Icon />
    </div>
  </div>
);
