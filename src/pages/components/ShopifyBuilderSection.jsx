  ...
  return (
    <section className="mx-0 md:mx-5 bg-white px-4 md:px-10 lg:px-14 pt-10 pb-10">
      <div className="w-full bg-white rounded-[24px] lg:rounded-[14px] flex flex-col lg:flex-row overflow-hidden border border-gray-100">
          ...
          <div className="relative z-10 grid grid-cols-2 pt-5 w-full">
            <div className="p-6 md:p-10 border-b border-r border-gray-600/40 flex flex-row items-start justify-start gap-3 md:gap-4">
              ...
              <div className="flex flex-col">
                <div className="text-xl md:text-3xl font-semibold text-white leading-none tracking-tighter">
                  1000+
                </div>
            ...
            <div className="p-6 md:p-10 border-r border-gray-600/40 flex flex-row items-start justify-start gap-3 md:gap-4">
              ...
              <div className="flex flex-col">
                <div className="text-xl md:text-3xl text-white font-semibold leading-none tracking-tighter">
                  550+
                </div>
                <p className="text-gray-400 text-[10px] md:text-[12px] font-bold uppercase tracking-wider mt-2 leading-tight">
                  Five Star Reviews
        ...
        {/* RIGHT: COPY + CTA */}
        <div className="w-full lg:w-1/2 p-5 md:p-12 lg:px-20 xl:px-24 flex flex-col justify-center bg-light-bg order-1 lg:order-2">
          ...
          <h1 className="text-2xl md:text-4xl leading-tight text-black mb-4 md:mb-6 text-left">
            <span className="font-bold">Build</span> Your Custom{' '}
          ...
          <p className="text-gray-600 text-base md:text-lg mb-6 md:mb-8 text-left mx-auto lg:mx-0 max-w-lg">
            Launch your brand-ready Shopify store with Arctic Grey—expertly designed, fully
            integrated, and optimized for 30%+ higher conversions.
          </p>
          ...
          <div className="">
            {['Accelerate Growth', 'Future-Ready Design', 'Expert Partnership'].map((text) => (
              <div
                key={text}
                className="flex justify-between items-center py-3 md:py-6 border-b border-gray-200 group cursor-pointer transition-all lg:px-5"
              >
                <span className="text-base md:text-lg font-semibold group-hover:text-primary-accent transition-colors">
                  {text}
                </span>
                <span className="text-xl group-hover:translate-x-1 group-hover:text-primary-accent transition-all">
                  →
                </span>
              </div>
            ))}
          ...
          <div className="mt-8 md:mt-12 flex justify-center lg:justify-start">
            <button className="group w-full sm:w-auto bg-primary-accent text-black rounded-full py-4 md:py-5 px-6 md:px-8 flex items-center justify-center lg:justify-between text-sm md:text-lg font-bold hover:bg-light-text transition-all">
