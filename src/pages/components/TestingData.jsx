  ...
  return (
    <div className="mx-0 md:mx-5 bg-white py-10 md:py-16 px-4 md:px-10 lg:px-14">
      <section className="max-w-[1600px] mx-auto">
        <div className="bg-light-bg rounded-[20px] md:rounded-[15px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center">
          {/* IMAGE */}
          ...
          <div className="px-6 pb-12 pt-4 md:px-12 lg:pr-20 lg:py-20 flex flex-col justify-center lg:ml-10 xl:ml-20 max-w-xl mx-auto lg:mx-0 text-left order-2">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-zinc-600 text-base md:text-lg leading-relaxed font-light">
                Optimize your Shopify site with data-driven decisions through A/B testing. Move
                beyond guesswork and drive growth by measuring the impact of your changes.
              </p>
            </div>
            ...
            <div className="mt-8 md:mt-10 divide-y divide-zinc-200 border-t border-zinc-200 text-left">
              <FeatureRow
                ...
                title="Strategize, Design, Develop, Deploy"
              />
            ...
            <div className="mt-8 md:mt-10 flex justify-center lg:justify-start">
              <button className="w-full sm:w-auto bg-primary-accent text-black px-8 md:px-12 py-4 rounded-full font-semibold flex items-center justify-center gap-3 hover:bg-light-text transition-all group shadow-md active:scale-95">
                Start the A/B Test Drive
                <span className="group-hover:translate-x-2 transition-transform duration-300 italic text-xl md:text-2xl">
                  →
                </span>
              </button>
            </div>
...
const FeatureRow = ({ Icon, title }) => (
  <div className="flex items-center justify-between py-4 md:py-6 group cursor-pointer transition-all rounded-md px-2 md:px-4 border-b border-zinc-100 last:border-0">
    <span className="text-sm md:text-lg font-medium text-zinc-900 group-hover:text-primary-accent transition-colors pr-4">
      {title}
    </span>

    <div className="text-zinc-800 group-hover:text-primary-accent transition-colors shrink-0">
      <Icon />
    </div>
  </div>
);
