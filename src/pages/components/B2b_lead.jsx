  ...
  return (
    <div className="mx-0 md:mx-5">
      <section className="mx-auto w-full bg-white py-8 md:py-12 px-4 md:px-10 lg:px-14">
        <div className="bg-light-bg rounded-[14px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center min-h-fit lg:min-h-[600px]">
          {/* IMAGE */}
          ...
          <div className="p-5 md:p-16 lg:p-24 flex flex-col justify-center order-2 lg:order-2 items-center lg:items-start text-left">
            <div className="space-y-4 md:space-y-6 max-w-lg">
              ...
              <h2 className="text-[20px] sm:text-3xl md:text-4xl text-zinc-900 leading-[1.1] tracking-tight sm:whitespace-normal">
                Why{" "}
                <span className="font-bold border-b-2 md:border-b-4 border-primary-soft text-primary-accent">
                  B2B
                </span>{" "}
                Leads The Way
              </h2>
              ...
              <p className="text-zinc-600 text-base md:text-lg leading-relaxed font-light mx-auto lg:mx-0">
                ...
                beyond guesswork and drive growth by measuring impact.
              </p>
            </div>
            ...
            <div className="mt-8 md:mt-10 w-full sm:w-auto">
              <button className="bg-primary-accent text-black px-8 md:px-10 py-4 rounded-full font-bold flex items-center justify-center gap-3 hover:bg-light-text transition-all group shadow-xl active:scale-95 text-[12px] md:text-sm uppercase tracking-widest w-full sm:w-auto">
                Explore Features
                <span className="group-hover:translate-x-2 text-xl md:text-2xl transition-transform duration-300">
                  →
                </span>
              </button>
            </div>
...
const FeatureRow = ({ Icon, title }) => (
  <div className="flex items-center justify-between py-4 md:py-6 group cursor-pointer transition-all duration-300 px-4 lg:px-6 -mx-3">
    <span className="text-sm md:text-lg font-semibold text-black group-hover:text-primary-accent transition-colors">
      {title}
    </span>
    <div className="text-black group-hover:text-primary-accent transition-colors">
      <Icon />
    </div>
  </div>
);
