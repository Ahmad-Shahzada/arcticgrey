...
const testimonialData = [
  {
    ...
    videoPoster: "/vidio/vidio-1.mp4",
    stat: "34%",
    statLabel: "Sales Increase in 6 Months",
    quote:
      "Arctic Gray has been instrumental in enhancing user experience, increasing conversion rates, and providing essential backend development support that has propelled our business growth.",
    author: "Jen Apple",
  ...
  },
  {
    ...
    videoPoster: "/vidio/vidio-2.mp4",
    stat: "22%",
    statLabel: "Increase in Retention",
    quote:
      "The team's attention to detail and ability to scale our Shopify operations was truly impressive. They are a core part of our digital strategy.",
...
const BrandsAndTestimonials = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-1 py-10 font-sans">
        ...
        <div className="px-4 md:px-8 lg:px-4 relative z-10 w-full">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center group-hover:bg-black/20 transition-all duration-300 bg-black/10">
              <div
                className={`w-16 h-16 md:w-20 md:h-20 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 ${
              ...
              <div className="flex flex-col sm:flex-row items-stretch">
                <div className="bg-white px-6 py-6 lg:px-10 lg:py-8 rounded-br-[2.5rem] flex items-center justify-center min-w-[150px] lg:min-w-[200px]">
                  <img
                    src={data.brandLogo}
                    alt="Brand Logo"
                    className="h-8 lg:h-10 w-24 lg:w-28 object-contain"
                  />
                </div>

                <div className="flex-1 flex items-center px-4 pb-4 sm:pb-0">
                  <div className="bg-light-bg flex items-center gap-3 px-4 py-3 lg:px-6 lg:py-4 rounded-2xl border border-primary-soft w-full sm:ml-4">
                    <span className="text-black font-black text-xl lg:text-2xl leading-none">
                      <span className="bg-primary-gradient bg-clip-text text-transparent inline-block">
                        {data.stat}
                      </span>{" "}
              ...
              <div className="p-6 md:p-8 lg:p-12">
                ...
                <div className="flex justify-between items-end">
                  <div className="flex flex-col">
                    <h4 className="text-black font-black text-lg lg:text-xl mb-1">
                      {data.author}
                    </h4>
                  ...
                  <button
                    onClick={handleNext}
                    className="w-10 h-10 lg:w-12 lg:h-12 bg-primary-accent rounded-full flex items-center justify-center transition-transform hover:scale-105 active:scale-95 shrink-0"
                  >
                    <svg
        ...
        <div className="bg-white rounded-[2rem] lg:rounded-2xl px-6 py-12 md:px-12 lg:px-24 lg:mr-4 flex flex-col justify-center">
          <div className="w-full">
            <h2 className="text-3xl md:text-4xl lg:text-5xl text-black tracking-tighter font-medium leading-[1.1] mb-10 lg:mb-20 text-center">
              ...
              Trusted by the Worlds <br className="hidden md:block" /> Most
              Innovative Brands
            </h2>
            ...
            <div className="relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden group">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-12 md:gap-y-16 gap-x-8 animate-infinite-scroll">
                {[...brands, ...brands, ...brands].map((brand, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-center h-12 md:h-16 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500"
                  >
